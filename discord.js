...
module.exports = class{
    constructor(server_id){
        ...
        this.guilds = [];
        this.rest = new REST({ version: '10' }).setToken(this.server_props.token);
        ...
        this.client.on('ready', ()=> {
            this.channels = this.server_props.channels.map(ch => {
        ...
        this.registerIntervalId = setInterval(()=>{
            this.rest.put(
                Routes.applicationCommands(this.server_props.clientId),
                { 
